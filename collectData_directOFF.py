...
LO = 1499e6 #40 MHz for example. Keep in mind the LO must be great or equal to 25 MHz, and less that 1750 MHz
...
np.savetxt("dataName.gz",data_2D) #you will likely get errors saving a 3D array this way - for the purpose of this lab, you do not need to save the full 3D array